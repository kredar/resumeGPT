      ...
      >
        <ReactMarkdown
          ...
          components={{
            ...
            strong: ({children}) => <strong className={isUser ? 'font-semibold text-white' : 'font-semibold text-gray-900'}>{children}</strong>,
            ...
            code: ({children}) => <code className={`px-1.5 py-0.5 rounded text-sm ${isUser ? 'bg-blue-700' : 'bg-gray-100 text-gray-800'}`}>{children}</code>,
          }}
        >
          {message.content}
        </ReactMarkdown>
